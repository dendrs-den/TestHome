...
func Load() Config {
	...
	tournamentsDB := getEnv("TOURNAMENTS_DB_PATH", "")
	...
	return Config{
		...
		HardwareMode:            mode,
		JournalPath:             journal,
		TournamentsDBPath:       tournamentsDB,
		...
		RequireOperatorPassword: getEnvBool("OPERATOR_PASSWORD_REQUIRED", false),
